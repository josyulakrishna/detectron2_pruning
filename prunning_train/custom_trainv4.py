...
# /nfs/stak/users/josyulag/hpc-share/AugData/mask_flow

######## REGISTER DATASET #################
print("registering")
register_coco_instances("pruningTrain", {}, r"C:\Users\davijose\Pictures\TrainingData\RealData\NewLabelledData\detectron_training\train.json", r'C:\Users\davijose\Pictures\TrainingData\RealData\NewLabelledData\detectron_training')
# register_coco_instances("pruningVal", {}, "/home/josyula/Documents/DataAndModels/pruning_training/val.json", "/home/josyula/Documents/DataAndModels/pruning_training/val")
# register_coco_instances("pruningTest", {}, "/home/josyula/Documents/DataAndModels/pruning_training/test.json", "/home/josyula/Documents/DataAndModels/pruning_training/test")
...
def load_data(dataset_dict):
    ...
    file_id = dataset_dict['file_name'].replace('.tiff', '')

    mask = np.asanyarray(Image.open(f'{file_id}_mask.png'))[:,:,0]
    flow = np.asanyarray(Image.open(f'{file_id}_flow.png'))[:,:,:3]
    image = torch.from_numpy(np.dstack([mask, flow]).transpose(2,0,1))
    return { "image": image, 'instances': dataset_dict['annotations']}
...
class CocoTrainer(DefaultTrainer):
  ...
  def build_train_loader(cls, cfg):
      return build_detection_train_loader(cfg, mapper=load_data)
...
cfg.OUTPUT_DIR ="/home/josyula/Programs/detectron2/prunning_train/output_with_mask"
